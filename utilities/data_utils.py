...
def transform_target(target):
    ...
    # transform the target, such that each neuron
    # can be represented with one label
    transformed = []
    transformation = {}
...
def create_association(unit_outputs, labels, probabilities=False):
    """Take a list of unit outputs and calculate which unit
        most likely belongs to which label
